# -*- coding: utf-8 -*-
"""
Created on Tue Dec 18 15:10:10 2018
...
class Tela(object):
    ...
    def boas_vindas(self):
        ...
        self.stdscr.addstr(16, 1, "Desenvolvido por Valdir.")
    ...
    def ajuda(self):
        ...
        self.stdscr.addstr(2, 1, "Para mudar a posicao, use as teclas: A, S, W, D")
        self.stdscr.addstr(3, 1, "Para definir uma posicao do jogo, aperte: Enter.")
